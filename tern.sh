...
run_with_delay rm -r executor-linux-v0.28.0.tar.gz

# Download the new tar.gz file
run_with_delay wget https://github.com/t3rn/executor-release/releases/download/v0.29.0/executor-linux-v0.29.0.tar.gz

# Extract the tar.gz file
run_with_delay tar -xvzf executor-linux-v0.29.0.tar.gz
...
# Ask the user for their gas price
read -p "Enter your Gas price: " EXECUTOR_MAX_L3_GAS_PRICE
run_with_delay export EXECUTOR_MAX_L3_GAS_PRICE=$EXECUTOR_MAX_L3_GAS_PRICE
